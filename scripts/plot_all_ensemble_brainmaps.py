...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#                         LOOP OVER ALL RECEPTOR FAMILIES
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
import re
...
print("Generating ensemble brainmaps for all 19 receptor families...")
for family_name in family_names:
    ...
    # Slices first 400 cortical regions
    ...
    family_clean = sanitize_filename(family_name)
    p.build(dpi=300, save_as=f'figs/{family_clean}_ensemble_brainmap.pdf')
    print(f"Generated figs/{family_clean}_ensemble_brainmap.pdf (family: {family_name})")

print("All ensemble brainmaps generated successfully!")
